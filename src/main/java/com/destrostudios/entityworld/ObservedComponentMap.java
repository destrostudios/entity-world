...
class ObservedComponentMap extends SimpleComponentMap {
    ...
    private Map<Class<?>, HashSet<ComponentMapObserver>> componentObserverMap = new HashMap<>();
    private Map<Object, ComponentMapObserver> systemObserverMap = new HashMap<>();
    private Map<Object, ComponentMapObserver> systemGlobalObserverMap = new HashMap<>();
    ...
    public ComponentMapObserver requestObserver(Object key, Class... componentClasses) {
        return requestObserver(key, DefaultComponentEqualityDefinition.INSTANCE, componentClasses);
    }

...
public class BitOutputStream {
    ...
    public void writeString_UTF8(String string, int maximumBytesCountBits) {
        try {
            ...
            System.out.println("Error while encoding string: " + ex);
        }
    }
    ...
    public void writeBits(int value, int count) {
        ...
        int remaining = count;
        while ( remaining > 0 ) {
            int bitsToCopy = Math.min(bits, remaining);
            ...
            // If there are no more bits left to write to in our working byte then write it out and clear it.
            if(bits == 0) {
                flush();
            }
        }
    ...
    protected void flush() {
        try {
            ...
            System.out.println("Error while flushing bit stream: " + ex);
        }
    }
    ...
    public void close() {
        ...
        try {
            ...
            System.out.println("Error while closing bit stream: " + ex);
        }
    }
